...
\begin{figure}[h!tbp]
 ...
 \label{fig:quadrangularPyramidType1}
\end{figure}
...
\begin{proposition}
The limit set $\Lambda(G)$ of a sphairahedron of the type (a) and of the type (b) is  the union of a plane and $\infty$. 
\end{proposition}
...
In this pyramid  case, the tiling group $G$ is $3$-Kleinian after all.  The coloring pattern of the limit set is generated by reflections on the plane.  See ****.  Here is four lines and one circle, ..... %あとで考えます。
