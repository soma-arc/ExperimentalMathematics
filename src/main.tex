...
Let $T$ be a sphairahedron.  Let $\overline{D_i}$ ($i = 1,2,\ldots, p$) be the closed ball of $T$ and $S_i$ be the boundary sphere of $\overline{D_i}$.  Suppose that a map $I(S_i):S^3 \to S^3$ is the inversion map of $S_i$.  $I(S_i)$ is an orientation-reversing Moebius map on $S^3$ and let $G$ be a group generated by all $I(S_i)$'s.
