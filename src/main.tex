...
\begin{figure}[h!tbp]
 \begin{minipage}{0.5\textwidth}
  ...
  \end{minipage}
  \hspace*{\fill}
  \caption{Finite pentahedral prism type(a)*1*.}
 ...
 \begin{minipage}{0.5\textwidth}
  ...
  \end{minipage}
  \hspace*{\fill}
  \caption{Finite pentahedral prism type(a)*2*.}
...
\begin{figure}[h!tbp]
 \begin{minipage}{0.5\textwidth}
  ...
  \end{minipage}
  \hspace*{\fill}
  \caption{Finite tetrahedron type(a)*3*.}
  \label{fig:pentahedralPrismFinite}
 \end{minipage}
 \hspace*{\fill}
 \begin{minipage}{0.5\textwidth}
  ...
  \end{minipage}
  \hspace*{\fill}
  \caption{Finite pentahedral pyramid type(a)*4*.}
...
It is difficult to determine coordinates and radii of the three spheres
at side faces.
...
\begin{figure}[H]
  \begin{minipage}[t]{0.3\textwidth}
   ...
   \caption{hexahedral cake type four}
   \label{fig:cake4}
  \end{minipage}
 \hspace*{\fill}
  \begin{minipage}[t]{0.3\textwidth}
...
\item Figure \ref{fig:pentahedralPrismFinite}: Finite pentahedral prism
      type(a)*1*.
\item Figure
...
\item Figure \ref{fig:pentahedralPrismInfPositive}: Finite pentahedral
      prism type(a)*2*. 
\item Figure
...
\item Figure \ref{fig:pentahedralPrismFinite}: Finite tetrahedron
      type(a)*3*.
\item Figure
...
\item Figure \ref{fig:pentahedralPrismInfNeg}: Finite pentahedral pyramid
      type(a)*4*.
\item Figure
