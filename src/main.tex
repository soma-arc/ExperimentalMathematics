...
IIS can be used to render fractals based on circle or sphere inversions.
\cite{bridges2016}\cite{bridges2017}

The previous paper is focused on the artistical perspective.
...
appearance only by them. We can see more pixtures and more movies in the
...
Pentahedron has two type. pentahedra pyramid is alsp sphere and plane.
However it is different from two sphere and plane.
