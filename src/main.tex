...
The parameter space is shown in Figure \ref{fig:paramSpace}.% TODO replace image
...
The arms get longer as the parameter approaches
...
So, there are parameters on outside of the parameter space.
But we don't know that is point, curve, or regions.

In other parameter, lower half part of the parameter space.
The hole emerges in sphairahedron as in Figure \ref{fig:lowerPrism}, and
the limit set has tunnel like Figure \ref{fig:lowerLimit}.
