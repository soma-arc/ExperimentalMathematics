...
In each case, the parameter space consists on one point.  To show this fact, it is enough to suppose that one vertex is the infinite point and the sphairahedron is they have no parameter.
