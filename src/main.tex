...
we have t0 compute infinite number of sphairahedra.
Ray marching
...
三次元でレンズ空間を考えた．
He also calculate the parameter space of the cube-type sphairahedra
apart from Ahara and Araki.
However his thesis is written in Japanese.
