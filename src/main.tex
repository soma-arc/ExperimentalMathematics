...
Let $L$ be the tiling generated by a tile $T$ and a transform group $G$, that is, piece set of $L$ consists of $g(T)$ for all $g\in G$.  We represent $L$ by the pair $(T,G)$ of the fundamental tile $T$ and the transformation group $G$.  The rationality condition guarantees the local consistency of tiling satisfies because of Poincare's polyhedron theorem.  
