...
It is difficult to compute ideal rational sphairahedra based on
...
\begin{proposition}
 The vertex of the ideal rational sphairahedron, should not
 have vertexes connecting five or more edges.
\end{proposition}
...
patterns of sphairahedra.
After that, we have to draw infinite number of sphairahedra, and it
takes much time.
...
たくさんの円が交わる各頂点は収束が遅くなる．たくさんタイルが必要になるの
で
