...
\subref{fig:terrainStep10}\subref{fig:sphairaPrismFinal} near here)
...
\begin{proposition}\label{prop:paraSpace_Tetrahedon}
...
\begin{proof}
We show it in case of the type (a).  Let $\overline{D_i}$'s be as in the proof of Proposition \ref{prop:paraSpace_Tetrahedon}.  The tetrahedron $T$ is given by 
\[
...
\begin{figure}[h!tbp]
 \begin{minipage}{0.5\textwidth}
  \begin{minipage}[t]{0.24\textwidth}
   ...
   \subcaption{Sphairahedron}
   \label{fig:pentahedralPrismSphairahedronFinite}
  \end{minipage}
  \hspace*{\fill}
  \begin{minipage}[t]{0.24\textwidth}
   \centering
   ...
   \subcaption{Limit set}
   \label{fig:pentahedralPrismLimitsetFinite}
  \end{minipage}
  \hspace*{\fill}
  \caption{Finite triangular prism type(a)*1*.}
  \label{fig:pentahedralPrismFinite1}
 \end{minipage}
 \hspace*{\fill}
 \begin{minipage}{0.5\textwidth}
  \begin{minipage}[t]{0.24\textwidth}
  ...
  \end{minipage}
  \hspace*{\fill}
  \caption{Finite triangular prism type(a)*2*.}
...
\begin{figure}[h!tbp]
 \begin{minipage}{0.5\textwidth}
  \begin{minipage}[t]{0.24\textwidth}
   ...
   \subcaption{Sphairahedron}
   \label{fig:pentahedralPrismInfSphairahedron3}
  \end{minipage}
  \hspace*{\fill}
  \begin{minipage}[t]{0.24\textwidth}
   \centering
   ...
   \subcaption{Limit set}
   \label{fig:pentahedralPrismInfLimit3}
  \end{minipage}
  \hspace*{\fill}
  \caption{Finite triangular prism type(a)*3*.}
  \label{fig:pentahedralPrismFinite2}
 \end{minipage}
 \hspace*{\fill}
 \begin{minipage}{0.5\textwidth}
  \begin{minipage}[t]{0.24\textwidth}
  ...
  \end{minipage}
  \hspace*{\fill}
  \caption{Finite triangular prism type(a)*4*.}
  \label{fig:pentahedralPrismInfNeg}
 \end{minipage}
\end{figure}

A triangular prism (Figure \ref{fig:triangularPrism}) is a sphairahedon with a polyhedral structure as seen in Figure \ref{fig:triangularPrismPolyhedralStructure}.  There six combinations of dihedral angles as in Figures \ref{fig:triangularPrismDihedralAngles}.

\begin{proposition}\label{prop:paraSpace_TriangularPrism}
The parameter space of triangular prism of type 1 is an empty set.  But that of semi-sphairahedra of triangular prism type 1 is the disjoint union of two open intervals, one dimensional.
\end{proposition}
...
\begin{proof}
We show this proposition in case of type 1.  Following Figure \ref{fig:triangularPrismPolyhedralStructure}, we assume that one of the vertex is $\infty$.
...
We focus on the plane $O_1=\{ (x,y,z) \mid x=1\}$ and let $r'_2$, $r'_4$ be the radius of the intersection circles of $O_1$ and $O_2$(, repectively $O_1$ and $O_4$.) 
Here we know that $r'_4=\sqrt{3}$ is a constant.  Applying Lemma \ref{lemma:twoCirclesChain},  $2r'_4=w=2\sqrt{3}$ and we have $r'_2=\dfrac{z_2^2}{2w}$ and we have
\[
0 < \dfrac{z_2^2}{2w} < \dfrac{w}{2},
\] 
This implies $-\sqrt{3}<z_2<0, 0<z_2<\sqrt{3}$. For any $z_2$ satisfying these inequalities, the coordinates of all $O_i$'s are determined.  See Figure ****, $S^3\setminus \bigcup \overline{D_i}$ has three connected components.  Thus, this $\overline{D_i}$'s do not give us a sphairahedron but a semi-sphairahedron. 
\end{proof}
...
%Figure \ref{fig:pentahedralPrismInfPositive}
%\subref{fig:pentahedralPrismInfPositiveLimit}.
...
\noindent(Figure \ref{fig:cubes} near here)\\
(Figure \ref{fig:chainCircles} near here)
(Figure \ref{fig:infTriangle} near here)
...
\begin{figure}[h!tbp]
 ...
 \begin{minipage}[t]{0.5\textwidth}
  ...
  \caption{Slice of triangular prism.}
...
\end{proof}
 ...
 Using this Lemma \ref{lemma:sum}, we obtain the following lemma in a combinatorial way.
...
\noindent(Figure \ref{fig:cubePolyhedralStructure} near here)\\
(Figure \ref{fig:cubeGraph}\subref{fig:cube_a}
...
\theta_{15} + \theta_{35} = \pi$ by Lemma\ref{lemma:sum}.
...
\begin{figure}[h!tbp]
 ...
 \caption{Side face of cube type sphairahedron.}
 \label{fig:sideFace}
 \end{minipage}
 \hspace*{\fill}
 \begin{minipage}[t]{0.5\textwidth}
...
% We complete the proof of the main Theorem \ref{main}. % main theorem
...
\subref{fig:planeTetra}\subref{fig:planePentaPrism} near here)\\
...
\begin{itemize}
 ...
 \item Figure \ref{fig:sphairahedronTile}: Tiling of a finite cube-type
       sphairahedron.
 \item Figure \ref{fig:sphairahedronTile}\subref{fig:sphaira-step1}: Step 0.
 \item Figure \ref{fig:sphairahedronTile}\subref{fig:sphaira-step2}: Step 1.
 ...
 \item Figure \ref{fig:sphairahedralPrismTile}\subref{fig:terrainStep5}:
       Step 5.
 \item Figure \ref{fig:sphairahedralPrismTile}\subref{fig:terrainStep10}:
       Step 10.
 \item Figure
...
\item Figure \ref{fig:pentahedralPrismInfPositive}: Finite triangular
      prism  type(a)*2*. 
\item Figure
      \ref{fig:pentahedralPrismInfPositive}\subref{fig:pentahedralPrismInfPositiveSphairahedron}: Sphairahedron.
\item Figure
...
\item Figure \ref{fig:pentahedralPrismInfNeg}: Finite triangular prism
      type(a)*4*.
\item Figure
...
\item Figure \ref{fig:cubes}: Faces and vertexes of cube.
\item Figure \ref{fig:chainCircles}: Chain of circles.
\item Figure \ref{fig:infTriangle}: Slice of triangular prism.
...
\item Figure \ref{fig:sideFace}: Side face of cube type sphairahedron.
\item Figure \ref{fig:sphairahedronSlice}: Slice of the infinite
      sphairahedron.
...
\item Figure \ref{fig:planes}\subref{fig:planeCake}: Hexahedral cake2.
\item Figure \ref{fig:planes}\subref{fig:planeTetra}: Tetrahedron.
\item Figure \ref{fig:planes}\subref{fig:planePentaPrism}: Pentahedral
      prism.
