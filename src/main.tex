...
(2)\ The edges $e_{12},e_{14},e_{24}$ are tangent to each other at a point.
...
(5)\ The edges $e_{24},e_{26},e_{46}$ are tangent to each other at a point.
\end{lemma}
...
(2) Applying Lemma \ref{lemma:twoCirclesChain} and the equations (*), we show The edges $e_{12},e_{14}$ are tangent to each other.  


have  Let $\theta'_{24}$ be the face-angle of $O_2$ and $O_4$. From the
