...
\overline{D_6}&=\{(x,y,z) \mid (x-x_6)^2+(y-y_6)^2+(z-z_B)^2<r_6^2 \} \\
 r_2 &= \dfrac{2z_Az_B + 3}{6}.\\
(x_2, y_2) &= \left(\frac{1}{2}(1-r_2), -\frac{\sqrt{3}}{2}(1-r_2)\right),\\
 r_4 &= \dfrac{2z_A(z_A-z_B) + 3}{6}.\\
(x_4, y_4) &= \left(\frac{1}{2}(1-r_4), \frac{\sqrt{3}}{2}(1-r_4)\right),\\
 r_6 &= \dfrac{2z_B(z_B-z_A) + 3}{6}.
(x_6, y_6) &= \left(r_6-1, 0\right),\\
\end{align*} 
The parameter space is as seen in Figure \ref{fig:graphCubeALimit}.
\[
0 \le z_A,\ z_B \ge 2 z_A, \ z_B(z_B-z_A)<\frac{3}{4}
\]
\bigskip\par
Type 2:%図はこちらに移す。
\bigskip\par
