...
Ahara and Araki published graphics and mathematical theory about a sphairahedron
and a quasi-sphere in ICG 2002, that is, international conference about
computer graphics. 
...
quasi-sphere in real-time under limited conditions
...
fractal paintings named ``L'art fractal''. One of works in the book called
``Quasi-Quasi-Grail'' is based on Ahara and Araki fractal.

After that, in 2017, a breakthrough is came out. 
...
IIS is the way to render CG related to finitely generated group
generated by symmetry transformations and inversions pixel by pixel.
It can be easy to parallelize and render image fast. 
...
In this paper, we aim to following purposes.
First, we survey history of these quasi-spheres.
Second, we rearrange the paper about parameter space of sphairahedra
written in Japanese and report comprehensive result.
Third, we propely introduce and prove mathematical theory implicitly
