...
In this case, the tiling group $G$ is $3$-Kleinian after all.  Figures \ref{fig:quadrangularPyramid_Inf_1}(d) and \ref{fig:quadrangularPyramid_Inf_2}(d) show the coloring patterns on the limit set.  They are generated by the reflections of four lines and one circle as seen in Figures \ref{fig:quadrangularPyramid_Inf_1}(c) and \ref{fig:quadrangularPyramid_Inf_2}(c) respectively.
