...
\begin{figure}[H]
 \begin{minipage}{0.5\textwidth}
  ...
  \end{minipage}
  \hspace*{\fill}
  \caption{Finite tetrahedron type 1.}
...
\begin{minipage}[t]{0.24\textwidth}
 ...
 \label{fig:pentahedralPyramidSphairahedronFinite2}
  ...
  \end{minipage}
  \hspace*{\fill}
  \caption{Finite tetrahedron type 2.}
...
\begin{itemize}
 ...
 \item Figure \ref{fig:quasi-sphere}\subref{quaso-sphere1}:
 \item Figure \ref{fig:quasi-sphere}\subref{quaso-sphere2}:
 \item Figure \ref{fig:quasi-sphere}\subref{quaso-sphereZoom}:
...
\item Figure \ref{fig:pentahedralPyramidFinite}: Finite tetrahedron
      type1.
\item Figure
...
\item Figure \ref{fig:pentahedralPyramidFinite2}: Finite tetrahedron
      type 2.
\item Figure
