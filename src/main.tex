...
\]
If we regard the upper half plane $\{(x,y,z) \mid z>0\}$ as the hyperbolic space $\mathbb{H}^3$, $T$ is a hyperbolic ideal tetrahedron.  If the tiling $L=(T,G)$, then the boundary of the total tiling space $\varlimsup_{k\to\infty} |L|_k$
...
\begin{align*}
\overline{D_1}&=\{(x,y,z) \mid x_1 \le x \} \cup\{\infty\}\\
\overline{D_2}&=\{(x,y,z) \mid y_3 \le y \} \cup\{\infty\}\\
...
$S^3\setminus(\overline{D_1}\cup\overline{D_2}\cup\overline{D_3}\cup\overline{D_4})$ is a rectangular column. The vertex set is $P_{135}, P_{145}, P_{235}, P_{245}, \infty$, where $P_{ijk}=\overline{D_i}\cap\overline{D_j}\cap\overline{D_k}$.  Suppose that $P_{135}$ is on the $xy$-plane, that is, $P_{135}=(x_1, y_3, 0)$.  $z_5=0$ follows from Lemma \ref{lemma:CenterOfSphere}(1).  Lemma \ref{lemma:CenterOfSphere}(3) indicates that the center $(x_5, y_5, 0)$ is on the plane $(x-x_1)+(y-y_3)$




\end{proof}
doesn't have a parameter. It has two patterns
