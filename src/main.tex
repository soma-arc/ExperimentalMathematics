...
We write \cite{bridges2018}
real-time rendering technique and 
Artistical perspective.
In this article, we discuss mathematical properties of
sphairahedra and its limit set.

In 2003 after they publish a 4 page paper \cite{}.
を出版しただけであったが，フラクタルアートに興味のあった者達には
初めて見る複雑性をもつ三次元のフラクタル構造であったため，コミュニティの
興味をひいた．
数学的には一部の球面体をRyo Kageyamaが追実験している．
...
mathematically.
この論文はsphairahedron, quasi-fuchsian fractalsを数学的に考察する論文で
ある．
...
Because pi / n (n >= 5)は360 /  となるkが存在しないため．
