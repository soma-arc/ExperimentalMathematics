...
\begin{figure}[h!tbp]
 ...
 keepaspectratio]{./im.g/HexahedraWithSphericalFaces/cubes.png}
 \caption{}
 \label{fig:cubes}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.5in, keepaspectratio]{./img/visualization/cubeArms.png}
 \caption{Cube}
 \label{fig:cubeArms}
\end{figure}
...
Upper half of infinite sphairahedron.
The limit set forms a hexagram-like shape, and we call six elongated parts
of the hexagram \textit{arms}. It is shown in Figure \ref{fig:cubeArms}.
...
lower half of infinite sphairahedron
...
When the arms elongated, the arms make hole to prism sphairahedron.

See Figure \ref{fig:cubeHoles}. It shows pink prism.
It is an upper half part of the infinite sphairahedron.
In Figure \ref{fig:cubeHole}\subref{fig:upperPrismSmallHole}
small hole appears. More crossing, the hole is bigger as shown in
...
There are many sphairahedra on blue tiles.
...
The bridge seems to be discrete when the arms crossing at pi/n.
