...
graphics and the simplest parameter space of cubic sphairahedra
...
In 2016, Ryo Kageyama\cite{kageyama} introduced the parameter space of the cubic
...
\overline{D_2}&= \{ (x,y,z) \mid *** \} \cup \{ \infty \}\\
\overline{D_3}&= \{ (x,y,z) \mid *** \} \cup \{ \infty \}\\
\overline{D_4}&= \{ (x,y,z) \mid *** \} \cup \{ \infty \}\\
...
Type 1:
\begin{align*}
\overline{D_1}&= \{ (x,y,z) \mid *** \} \cup \{ \infty \}\\
\overline{D_2}&= \{ (x,y,z) \mid *** \} \cup \{ \infty \}\\
\overline{D_3}&= \{ (x,y,z) \mid *** \} \cup \{ \infty \}\\
\overline{D_4}&= \{ (x,y,z) \mid *** \} \cup \{ \infty \}\\
\overline{D_5}&=\{(x,y,z) \mid (x-x_5)^2+(y-y_5)^2+z^5<r_5^2 \} \\
